...
- `POST /api/optimize` принимает фильтры и непустой объект `targets` с обязательными значениями. Незаданные характеристики не становятся пользовательскими приоритетами. Среди допустимых решений API строит ценовой, скоростной и защитный края, после чего отбирает варианты по различию характеристик, экипировки и состава артефактов.
